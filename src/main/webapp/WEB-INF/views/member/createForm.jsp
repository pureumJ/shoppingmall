...
<script type="text/javascript">
	function idCheck(id){
		if(id==''){
			...
			var url = "idcheck";
			var param = "id="+id;
    		$.get(url, param, function(data, textStatus) { //jQuery비동기 통신 (향후 fetch로 바꾸기)
	...
	<div class="container mt-3">
		...
		<form action="create"
			...
			<div class="input-group mb-3">
		  	...
		  	<div class="input-group mb-3">
			    <div class="input-group-text"><span id="need">* </span> 아이디</div>
		    	<input type="text" class="form-control"  placeholder="Enter id"  name="id">
		      	<button type="button" class="btn btn-info" onclick="idCheck(document.frm.id.value)"> ID 중복확인 </button>
		      	<div id="idcheck"></div>
		  	</div>
			<div class="input-group mb-3">
			 	<div class="input-group-text"><span id="need">* </span> 비밀번호</div>   
			  	<input type="password" class="form-control" placeholder="Enter passwd"  name="passwd">
			</div>
	  		<div class="input-group mb-3">
	    		<div class="input-group-text"><span id="need">*</span> 비밀번호 확인 </div>    
	  			<input type="password" class="form-control" placeholder="Enter repasswd"  name="repasswd">
			</div>
	  		<div class="input-group mb-3">
	    		<div class="input-group-text"><span id="need">*</span> 이름 </div>   
	        	<input type="text" class="form-control" id="mname" placeholder="Enter 이름"  name="mname">
        	</div>
	  		<div class="input-group mb-3">
	    		<div class="input-group-text"><span id="need">*</span> 전화번호 </div>
	 		...
	 		<div class="input-group mb-3">
	  		...
	  		<div class="input-group mb-3">
	    		...
	    		<input type="text" class="form-control" size="10" name="zipcode" id="sample6_postcode" placeholder="우편번호">     
	    		<button type="button" class="btn btn-info" onclick="sample6_execDaumPostcode()">주소검색</button>     
	  		</div>
	  		<div class="input-group mb-3">

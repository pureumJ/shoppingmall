...
public class ContentsController {
	...
	public String updateFile(int contentsno, String oldfile, MultipartFile filenameMF) {
	...
	@GetMapping("/admin/contents/delete/{contentsno}/{oldfile}")
	public String delete(@PathVariable("contentsno") int contentsno, @PathVariable("oldfile") String oldfile) {
		boolean flag = false;
	...
	@GetMapping({ "/contents/mainlist", "/contents/mainlist/{cateno}"})
	public String mainlist(@PathVariable(value="cateno", required=false) Integer cateno, HttpServletRequest request) {
